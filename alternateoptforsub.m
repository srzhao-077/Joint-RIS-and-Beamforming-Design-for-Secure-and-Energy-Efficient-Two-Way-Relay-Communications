function [best_Phi,best_A] = alternateoptforsub(nr,nt,Pb,sigm2,Ps,beita,itersmax_bcd,m,h1,h2,h3,g1,g2,g3,V,eta,iniphi,inia)
...
thres =0.6;
    ...
    while iter_bcd <= itersmax_bcd
        ...
        Phi = updatephiee_grad(m, Phi, Ps, Pb, h1, h2, h3, g1, g2, g3, V, A, beita, nr, sigm2, U1, U2, U3, W1, W2, W3, W4 ,eta);
