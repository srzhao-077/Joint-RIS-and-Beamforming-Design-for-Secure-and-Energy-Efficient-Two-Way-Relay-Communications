function [newPhi]=updatephi(m,Phi,Ps,Pb,h1,h2,h3,g1,g2,g3,V,A,beita,nr,sigm2,U1,U2,U3,W1,W2,W3,W4)
...
while (t<iter_max)
    ...
    minimize  2*real(valy_t'*funcg_grad)+const_g-c_page3;
...
Val1=getSumrate(h1,h2,h3,g1,g2,g3,V,Phi,A,Ps,sigm2);
Val2=getSumrate(h1,h2,h3,g1,g2,g3,V,newPhi,A,Ps,sigm2);
if Val1>Val2
    newPhi=Phi;
end
